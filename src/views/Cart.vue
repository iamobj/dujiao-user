                ...
                <div class="flex items-start justify-between gap-3">
                  <div class="min-w-0">
                    ...
                    <div class="mt-2 md:mt-3 flex flex-wrap gap-2">
                      ...
                      <Badge
                        :variant="itemDisplaysAutoFulfillment(item) ? 'info' : 'neutral'"
                        size="xs"
                        class="uppercase tracking-wider"
                      >
...
const {
  ...
  cartItemKey, cartItemImage, itemDisplaysAutoFulfillment, itemFulfillmentLabel, itemSkuDisplay, itemSubtotal, itemStockHint, quantityWarning,
