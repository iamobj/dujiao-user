            ...
            <div class="p-6 md:p-8 lg:p-12 flex flex-col justify-center">
              <div class="mb-6">
                ...
                <div class="mb-6 flex flex-wrap items-center gap-2">
                  ...
                  <Badge :variant="displayedAutoFulfillment ? 'info' : 'neutral'">
                    <Zap v-if="displayedAutoFulfillment" class="h-3 w-3" />
...
const {
  ...
  categoryName, hasOrderFlowDelivery, visibleProductTags, displayedAutoFulfillment, images,
